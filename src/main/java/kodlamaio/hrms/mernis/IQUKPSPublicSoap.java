...
public class IQUKPSPublicSoap
{
    ...
    public IQUKPSPublicSoap(){}

    public IQUKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public IQUKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        IQUExtendedSoapSerializationEnvelope envelope= new IQUExtendedSoapSerializationEnvelope(IQUExtendedSoapSerializationEnvelope.VER11);
