...
public class IQUExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(IQUDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new IQUStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static IQUDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static IQUDateTimeConverter dateTimeConverter = new IQUStandardDateTimeConverter();

    public IQUExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public IQUExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new IQUMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=IQUHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,IQUExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=IQUHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
